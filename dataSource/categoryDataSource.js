...
class CategoryDataSource extends DataSource {
    ...
    // Dans les DataSource, on doit obligatoirement implémenter
    // une méthode initialize qui sera appelée par notre serveur
    // apollo pour faire de "l'injection de dépendance"
    initialize(config) {
        // config contiendra 2 propriétés
        // - "context" qui servira à faire passer les dépendances
        // - "cache" pour la gestion du cache interne
    ...
    categoriesLoader = new DataLoader(async (ids) => {
        ...
        // nos categorie sous la forme d'un tableau
